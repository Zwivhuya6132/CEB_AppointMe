...
?>
    ...
    <div class="new-clearfix fields-group">
        <div class="new-form-group fields names-in">
            ...
            <input type="text" id="account-holder" class="new-form-control inputs" >
        </div>
        
        <div class="new-form-group fields names-in">
            <label for="bank-name" class="new-label">Bank Name:</label>
            <input type="text" id="bank-name" class="new-form-control inputs">
        </div>
    ...
    <div class="new-form-group fields names-in">
        ...
        <input type="text" id="bank-branch" class="new-form-control inputs">
    </div>
    ...
    <div class="new-clearfix fields names-in">
        <div class="new-form-group fields">
            ...
            <input type="text" id="branch-code" class="new-form-control inputs">
        </div>
        
        <div class="new-form-group fields">
            <label for="account-number" class="new-label">Account Number:</label>
            <input type="text" id="account-number" class="new-form-control inputs">
        </div>
        
        <div class="new-form-group">
            <label for="account-type" class="new-label">Account Type:</label>
            <select id="account-type" class="new-form-control inputs">
    ...
    <div class="new-clearfix fields names-in">
        <div class="new-form-group fields">
            ...
            <input type="text" id="iban" class="new-form-control inputs">
        </div>
        
        <div class="new-form-group">
            <label for="swift-code" class="new-label">Swift Code (International):</label>
            <input type="text" id="swift-code" class="new-form-control inputs">
        </div>
        
        <div class="new-form-group">
            <label for="bank-address" class="new-label">Bank Physical Address:</label>
            <input type="text" id="bank-address" class="new-form-control inputs">
        </div>
    </div>
    <label for="upload">Attach Your proof of banking</label><br>
    <input type="file" class="inputs" name="" id="upload" style="border: 2px solid #2e1a46; padding: 5px; border-radius: 10px; cursor: pointer; margin-bottom:20px;">
