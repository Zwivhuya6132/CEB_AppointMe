...
<!-- Your existing HTML content above this line -->

<script>
  // Get all input elements within the form
  const inputs = document.querySelectorAll('form.disab input, form.disab select');

  // Loop through each input element and add the 'disabled' attribute
  inputs.forEach(input => {
    input.setAttribute('disabled', 'disabled');
  });
</script>

<!-- Your existing HTML content below this line -->
